   ...
   <div>
    {
        songList.map((song , index) => (
            <div key={song.id} className='gap-4 grid grid-cols-3  sm:grid-cols-4  p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer'>
